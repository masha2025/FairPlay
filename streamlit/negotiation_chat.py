...
def Questionnaire():
    ...
    transformed["Statement4"] = stat4
    transformed["Statement5"] = stat5
    transformed["Statement6"] = stat6
    transformed["Statement7"] = stat7
    transformed["Statement8"] = stat8
    transformed["Statement9"] = stat9
